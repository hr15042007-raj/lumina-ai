...
# --- MODE 3: THINKING DEBUGGER ---
    ...
    st.info("For students who think they know the topic. This will test your logic.")
    
    user_thought = st.text_area("Paste your understanding here:")
    
    if st.button("Debug My Thinking"):
        debug_prompt = f"""
        User thought: "{user_thought}".
        Act as a Socratic Teacher.
        1. Find flaws/gaps in logic.
        2. Ask 2 questions to make the user realize their mistake.
        3. Do NOT give the answer.
        """
        st.write(ask_gemini(debug_prompt))
